    ...
    <div>
      ...
      <div className="row">
        ...
        <div className="col-lg-4">
          ...
          <Panel
            header={<span>
                <i className="fa fa-address-book fa-fw" /> Connections
            </span>}
          >
            <ListGroup>
              <ListGroupItem href="" onClick={(e) => { e.preventDefault(); }}>
                <i className="fa fa-user fa-fw" /> Michael Kunisaki
              </ListGroupItem>
              <ListGroupItem href="" onClick={(e) => { e.preventDefault(); }}>
                <i className="fa fa-user fa-fw" /> Steven Tran
              </ListGroupItem>
              <ListGroupItem href="" onClick={(e) => { e.preventDefault(); }}>
                <i className="fa fa-user fa-fw" /> Ben Moon
              </ListGroupItem>
              <ListGroupItem href="" onClick={(e) => { e.preventDefault(); }}>
                <i className="fa fa-user fa-fw" /> Steven Tran
              </ListGroupItem>
